...
public partial class customerrpeort : System.Web.UI.Page
{
    DataTable dtable;
    SqlDataAdapter adp;
    ...
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["LMNDB2021"].ConnectionString);
        SqlDataAdapter da = new SqlDataAdapter("Select *  from  OrderedProducts", con);

        DataTable dt = new DataTable("table1");
        da.Fill(dt);
        ReportViewer1.ProcessingMode = ProcessingMode.Local;
        ReportViewer1.LocalReport.ReportPath = Server.MapPath("orderrport.rdlc");
