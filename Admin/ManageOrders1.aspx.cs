...
public partial class ManageOrders1 : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void gvManageOrders_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        SqlConnection cn = new SqlConnection(ConfigurationManager.ConnectionStrings["LMNDB2021"].ConnectionString);
        SqlCommand cmd = new SqlCommand(@"update [Order] set Status='" + ddlStatus.SelectedValue + "' where order_Code ='" + odid.Text.Trim() + "'", cn);
        cn.Open();
        cmd.ExecuteNonQuery();
        cn.Close();
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        string constr = ConfigurationManager.ConnectionStrings["LMNDB2021"].ConnectionString;
