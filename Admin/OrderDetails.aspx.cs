...
public partial class OrderHistory : System.Web.UI.Page
{
    ...
    protected void fillgrid()
    {
        if (Request.QueryString["invo"].ToString() != "")
        {
            ...
            SqlCommand cmd1 = new SqlCommand(@"SELECT * from Product,OrderedProducts where OrderedProducts.Prod_ID=Product.ProductID and OrderedProducts.OrderCode='" + odid + "'", cn1);
            cn1.Open();
