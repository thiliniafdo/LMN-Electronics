...
public partial class OrderHistory : System.Web.UI.Page
{
    ...
    protected void fillgrid()
    {
        if (Session["User"] != null)
        {
            ...
            SqlCommand cmd = new SqlCommand(@"Select * from [Order], Login  where  [Order].User_id = UserEmail  and Order_Code='" + odid + "' ", cn);
            cn.Open();
            ...
            SqlConnection cn1 = new SqlConnection(ConfigurationManager.ConnectionStrings["LMNDB2021"].ConnectionString);
            SqlCommand cmd1 = new SqlCommand(@"SELECT Productname,ImageURL,Category,Qty,OrderedProducts.Price,TotalAmount from Product,CategoryMaster,OrderedProducts where OrderedProducts.Prod_ID=Product.ProductID and OrderCode='" + odid + "'", cn1);
            cn1.Open();
